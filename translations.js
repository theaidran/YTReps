...
const translations = {
    en: {
        ...
        syncButtonTooltip: "If you are working on two devices, refresh the page before use. After finishing work, click Sync to save changes or enable auto synch",
    ...
    pl: {
        ...
        syncButtonTooltip: "Jeśli pracujesz na dwóch urządzeniach, to odśwież stronę przed użyciem. A po zakończeniu pracy kliknij Sync, aby zapisać zmiany lub włącz auto synch ",
